    ...
    <div className="pt-16 min-h-screen bg-gray-50">
      ...
      <div className="bg-[#002b4b] pt-20 pb-10 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 px-4">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Author Zone</h1>
      ...
      {/* Important Dates - Moved to top as requested */}
      {/* Note: Since this component has a dark background, it will blend seamlessly with the header */}
      <ImportantDates />
